...
typedef sdrplay_api_ErrorInfoT* (*sdrplay_api_GetLastError_t)(void);

// Device API function types
typedef sdrplay_api_ErrT        (*sdrplay_api_DebugEnable_t)(HANDLE dev, unsigned int enable); 
...
extern "C"
{
    ...
    _SDRPLAY_DLL_QUALIFIER sdrplay_api_ErrorInfoT* sdrplay_api_GetLastError(void);
